<template>
  <div v-if="toProfile">
    ...
    <div class="flex flex-wrap justify-center items-center gap-2 mt-5 mb-5">
      <input type="number" pattern="[0-9]*" v-model="store.basic.weather" inputmode="numeric" step="1"
        class="input input-xl input-success w-25" />Weather
      <input type="number" pattern="[0-9]*" v-model="store.basic.weight" inputmode="numeric" step="1"
        class="input input-xl input-success w-25" />Weight
      <input type="number" pattern="[0-9]*" v-model="store.basic.batch" inputmode="numeric" step="1"
    ...
    <div class="flex gap-5 justify-center items-center bg-green-100 p-5">
      <input type="number" pattern="[0-9]*" v-model="store.start.exhaust" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Exs</div>
      <input type="number" pattern="[0-9]*" v-model="store.start.environment" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
    ...
    <div class="flex gap-5 m-5 justify-center items-center">
      <input type="number" pattern="[0-9]*" v-model="store.start.gas" inputmode="numeric" step="0.1"
    ...
    <div class="flex flex-wrap justify-center gap-5 bg-yellow-200 p-5 mt-2">
      <input type="number" pattern="[0-9]*" v-model="store.middle.time" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Trm</div>
      <input type="number" pattern="[0-9]*" v-model="store.middle.exhaust" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Exs</div>
      <input type="number" pattern="[0-9]*" v-model="store.middle.beans" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Cf</div>
      <input type="number" pattern="[0-9]*" v-model="store.middle.environment" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Env</div>
    </div>
    <div class="divider">
    ...
    <div class="flex flex-wrap gap-4 m-5 justify-center items-center">
      <input type="number" pattern="[0-9]*" v-model="store.middle.gas" inputmode="numeric" step="0.1"
    ...
    <div class="flex flex-wrap justify-center gap-5 bg-yellow-400 p-5 mt-2">
      <input type="number" pattern="[0-9]*" v-model="store.crack.time" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Trm</div>
      <input type="number" pattern="[0-9]*" v-model="store.crack.exhaust" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Exs</div>
      <input type="number" pattern="[0-9]*" v-model="store.crack.beans" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Cf</div>
      <input type="number" pattern="[0-9]*" v-model="store.crack.environment" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Env</div>
    </div>
    <div class="divider">
    ...
    <div class="flex flex-wrap gap-4 m-5 justify-center items-center">
      <input type="number" pattern="[0-9]*" v-model="store.crack.gas" inputmode="numeric" step="0.1"
    ...
    <div class="flex flex-wrap justify-center gap-5 bg-yellow-500 p-5 mt-2">
      <input type="number" pattern="[0-9]*" v-model="store.end.time" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Trm</div>
      <input type="number" pattern="[0-9]*" v-model="store.end.exhaust" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Exs</div>
      <input type="number" pattern="[0-9]*" v-model="store.end.beans" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Cf</div>
      <input type="number" pattern="[0-9]*" v-model="store.end.environment" inputmode="numeric" step="0.1"
        class="input input-xl input-success w-25" />
      <div class="w-7">Env</div>
    </div>
...
onMounted(async () => {
  try {
    const response = await fetch('http://localhost:3000/entry/names', {
      headers: {
...
const getRecommends = async () => {
  try {
    ...
    const response = await fetch(`http://localhost:3000/entry/recommends?type=${type}&roast=${store.basic.roast}&weight=${store.basic.weight}&batch=${store.basic.batch}&name=${store.basic.name}&weather=${store.basic.weather}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      }
